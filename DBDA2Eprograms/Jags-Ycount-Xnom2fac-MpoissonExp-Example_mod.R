...
setwd('G:/My Drive/learning/20230220_BayesianStatistics/20230504_BayesianDogsBook/DBDA2Eprograms')
#------------------------------------------------------------------------------- 
#Load The data file 
#.............................................................................
# myDataFrame = read.csv( file="HairEyeColor.csv" )
# # Prior to R 4.0, read.csv() made strings into factors. Now must do it
# # explicitly if desired:
# myDataFrame$Hair = factor( myDataFrame$Hair )
# myDataFrame$Eye = factor( myDataFrame$Eye )
...
source("Jags-Ycount-Xnom2fac-MpoissonExp_mod.R")
#------------------------------------------------------------------------------- 
...
# Do cell proportions sum to 1?
DF1= data.frame(mcmcCoda[[1]])
ppxColNos= grep('ppx1x2p\\.[1-4]\\.[1-4]\\.',colnames(DF1))
summedPPX= apply(DF1[,ppxColNos],1,sum)
sum(summedPPX < 0.99 | summedPPX>1.001)
