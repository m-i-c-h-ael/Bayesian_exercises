...
#myData = read.csv("H:/My Drive/learning/20230220_BayesianStatistics/20230504_BayesianDogsBook/20230508_3coins.csv")
#myData= data.frame( y=c(), s=c())
