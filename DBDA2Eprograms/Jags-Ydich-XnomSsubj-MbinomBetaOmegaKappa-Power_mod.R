...
idealGroupMean = 0.44
idealGroupSD = 0.04
idealNsubj = 28       # more subjects => higher confidence in hypothesis
idealNtrlPerSubj = 10 # more trials => higher confidence in hypothesis
...
#use actual data
realDF= read.csv('H:/My Drive/learning/20230220_BayesianStatistics/20230504_BayesianDogsBook/DBDA2Eprograms/TherapeuticTouchData.csv')
realDF$s= as.numeric(as.factor(realDF$s))

# Run Bayesian analysis on idealized data:
mcmcCoda = genMCMC( data=realDF , saveName=NULL ,     #data=idealDatFrm
...
Nsubj = 40 ; NtrlPerSubj = 100  # 658 flips total
