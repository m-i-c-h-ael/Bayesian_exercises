...
myDataFrame= myDataFrame[myDataFrame$Org %in% c('CHEM','PSY','BFIN','ENG'),]
...
myDataFrame$LogSalary= log(myDataFrame$Salary)
...
for ( parName in c("b0","b1[1]","b2[1]","b1b2[1,1]","ySigma[1,1]","ySigma[1,2]","ySigma[5,2]","nu") ) {
