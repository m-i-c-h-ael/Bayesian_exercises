...
myDataFrame = read.csv( file="H:/My Drive/learning/20230220_BayesianStatistics/20230504_BayesianDogsBook/DBDA2Eprograms/Salary.csv" )
...
myDataFrame$LogSalary= log(myDataFrame$Salary,10)
str(myDataFrame)
...
if ( fileNameRoot == "SalaryNormalHom-" ) {
  ...
  compInfo = plotPost( 
    ...
    compVal=0 ,ROPE=NULL )  #c(-1000,1000)
  show(compInfo)
